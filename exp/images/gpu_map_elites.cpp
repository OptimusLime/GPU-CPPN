...
#include "fit/fit_empty.hpp"
#include <modules/nn2/gen_dnn.hpp>
#include <modules/nn2/gen_hyper_nn.hpp>
#include "phen/phen_gpu_connections.hpp"

// #include <glog/logging.h>
// Caffe -------------------------------------------------

#include <modules/map_elite/map_elite.hpp>
#include "eval/gpu_evaluate.hpp" // MPI
...
int main(int argc, char **argv)
{
  ...
  // this file.
	typedef sferes::fit::FitEmpty<Params> fit_t;
  ...
  typedef phen::GpuImageConnections<cppn_t, fit_t, Params> phen_t;
...
//  typedef eval::Eval<Params> eval_t;
  typedef eval::GpuEvaluate<Params> eval_t;	// TBB
  ...
  if (argc > 1) // if a number is provided on the command line
	{
		...
		boost::shared_ptr<boost::program_options::option_description> opt (new boost::program_options::option_description(
